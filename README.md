...
executed as such will not have their callback updated in onResume, thus will not gracefully accommodate configurationChanges gracefully compared to queued Tasks.