 ...
 * @author Noah Seidman
 */
public abstract class TaskExecutorDialogFragment extends DialogFragment implements ExecutorReferenceCallback{
	...
	super.onResume();
	TaskExecutorService.requestExecutorReference(TaskExecutorService.RETAIN_CURRENT_MODE, getActivity(), this, null);
    }
