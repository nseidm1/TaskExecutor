...
public class TaskExecutor {
     ...
     *            implications such as ordered ui callbacks.
     */
    ...
    /**
     * This method directly executes the Task, bypassing the queue. Useful for
     * the abstract TaskLoader. The Task will not be persisted to disk, no ui
     * callbacks will be posted unless a reference to the TaskExecutor is set
     * specifically on the supplied Task using
     * {@link Task#setTaskExecutor(TaskExecutor)}.
     * 
     * @param task
     * @return Future<?> For optimal use in a Loader, return a reference to the
     *         Future.
     * 
     */
    ...
    /**
     * @param seconds
     *            -1 disables this feature, and it's disabled by default. Set
     *            this value to milliseconds of time. After that amount of time
     *            elapses your Task will be interrupted. If it has yet to
     *            execute it will not execute. If the Task has already begun
     *            executing it will be interrupted, which may prove useful if
     *            the Task has a blocking operation like network communication.
     */
    ...
    /**
     * @param future
     *            If {@link #setInterruptTaskAfter(int)} is set to a millisecond
     *            value > 0 the Future<?> of the submitted Task will be canceled
    ...
    /**
     * @return boolean Returns the assigned state of the hard callbacks.
     */
    ...
    /**
     * This triggers the persisted queue on disk to occur in the Service. It's
     * done in the service to have Context available.
     */
